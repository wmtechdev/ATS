            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: FlutterSaadTheme.of(context).displayMedium.override(
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  style: FlutterSaadTheme.of(context).bodyLarge.override(
                        font: GoogleFonts.openSans(
                          fontWeight:
                              FlutterSaadTheme.of(context).bodyLarge.fontWeight,
                          fontStyle:
                              FlutterSaadTheme.of(context).bodyLarge.fontStyle,
                        ),
                        color: FlutterSaadTheme.of(context).secondaryText,
                        letterSpacing: 0.0,
                        fontWeight:
                            FlutterSaadTheme.of(context).bodyLarge.fontWeight,
                        fontStyle:
