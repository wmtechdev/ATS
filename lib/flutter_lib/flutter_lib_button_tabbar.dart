...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _FlutterLibButtonTabBarState tabBar;
...
/// A FlutterLib Design widget that displays a horizontal row of tabs.
class FlutterLibButtonTabBar extends StatefulWidget
  ...
  /// and the entire [FlutterLibButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<FlutterLibButtonTabBar> createState() => _FlutterLibButtonTabBarState();
}

class _FlutterLibButtonTabBarState extends State<FlutterLibButtonTabBar>
  ...
  @override
  void didUpdateWidget(FlutterLibButtonTabBar oldWidget) {
