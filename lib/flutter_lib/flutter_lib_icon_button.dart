...
class FlutterLibIconButton extends StatefulWidget {
  const FlutterLibIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<FlutterLibIconButton> createState() => _FlutterLibIconButtonState();
}

class _FlutterLibIconButtonState extends State<FlutterLibIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(FlutterLibIconButton oldWidget) {
