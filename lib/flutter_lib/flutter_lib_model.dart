...
Widget wrapWithModel<T extends FlutterLibModel>({
  required T model,
...
T createModel<T extends FlutterLibModel>(
...
abstract class FlutterLibModel<W extends Widget> {
...
class FlutterLibDynamicModels<T extends FlutterLibModel> {
  FlutterLibDynamicModels(this.defaultBuilder);
