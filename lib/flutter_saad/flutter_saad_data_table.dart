...
class FlutterSaadDataTableController<T> extends DataTableSource {
  FlutterSaadDataTableController({
    List<T>? initialData,
    int? numRows,
...
class FlutterSaadDataTable<T> extends StatefulWidget {
  const FlutterSaadDataTable({
    super.key,
  ...
  final FlutterSaadDataTableController<T> controller;
  final List<T> data;
  final int? numRows;
  ...
  @override
  State<FlutterSaadDataTable<T>> createState() =>
      _FlutterSaadDataTableState<T>();
}

class _FlutterSaadDataTableState<T> extends State<FlutterSaadDataTable<T>> {
  FlutterSaadDataTableController<T> get controller => widget.controller;
  ...
  @override
  void didUpdateWidget(FlutterSaadDataTable<T> oldWidget) {
