...
class FlutterSaadIconButton extends StatefulWidget {
  const FlutterSaadIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<FlutterSaadIconButton> createState() => _FlutterSaadIconButtonState();
}

class _FlutterSaadIconButtonState extends State<FlutterSaadIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(FlutterSaadIconButton oldWidget) {
