...
Widget wrapWithModel<T extends FlutterSaadModel>({
  required T model,
...
T createModel<T extends FlutterSaadModel>(
...
abstract class FlutterSaadModel<W extends Widget> {
...
class FlutterSaadDynamicModels<T extends FlutterSaadModel> {
  FlutterSaadDynamicModels(this.defaultBuilder);
