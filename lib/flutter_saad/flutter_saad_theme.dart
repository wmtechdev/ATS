...
abstract class FlutterSaadTheme {
  static FlutterSaadTheme of(BuildContext context) {
...
class LightModeTheme extends FlutterSaadTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0xFF1E3F58);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFF355674);
