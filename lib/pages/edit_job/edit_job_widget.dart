...
class EditJobWidget extends StatefulWidget {
  const EditJobWidget({super.key, required this.docRef, required this.docObj});

  /// Refrence JobView of Documetn to update
  final DocumentReference? docRef;

  /// Acutal Job Document
  final JobRecord? docObj;
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  await widget!.docObj!.reference.update({
                    ...createJobRecordData(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      FlutterLibDropDown<
                                                        String
                                                      >(
                                                        controller: _model.ddEmpTypeValueController ??=
                                                            FormFieldController<
                                                              String
                                                            >(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      FlutterLibDropDown<
                                                        String
                                                      >(
                                                        controller: _model.ddLocTypeValueController ??=
                                                            FormFieldController<
                                                              String
                                                            >(
